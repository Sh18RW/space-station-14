...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU"; // BF-localisation
        private const string FallbackCulture = "en-US"; // BF-localisation
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // BF-localisation

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // BF-localisation
            _loc.SetFallbackCluture(fallbackCulture); // BF-localisation
            _loc.AddFunction(culture, "MANY", FormatMany); // BF-localisation
