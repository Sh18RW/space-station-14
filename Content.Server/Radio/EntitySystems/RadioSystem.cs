...
public sealed class RadioSystem : EntitySystem
{
    ...
    public async Task SendRadioMessage(EntityUid messageSource, string message, RadioChannelPrototype channel, EntityUid radioSource, bool escapeMarkup = true)
    {
        ...
        var voiceId = "";
        if (TryComp<TTSComponent>(messageSource, out var ttsComp))
        {
        ...
        var ev = new RadioReceiveEvent(message, messageSource, channel, chatMsg, audioBytes);
