...
descriptions-cookie-fortune-dataset-47 = Stellar Extraction заставляет меня писать эти драные записки для печенек, пожалуйста помогите!
...
descriptions-cookie-fortune-dataset-77 = А вы знали, что более 70% сотрудников Stellar Extraction исчезают в первые пару лет своего контракта? Теперь знаете!
