...
traitor-role-greeting =
    ...
    Синдикату нужны специалисты, их решили получить путём захвата и принуждения. Вы были завербованы организацией для того, чтобы уничтожить командование лайнера, после чего перевезти специалистов в отведённое место.
    Вы на лайнере не один, среди экипажа были запрятаны ещё. Используйте кодовые слова для поиска агентов. Будте осторожны, на станции есть Служба Безопасности, не надейтесь, что вы сможете всё провернуть у них под носом.

    На станции где-то есть склад, на котором должно быть оружие. Вооружитесь там, после чего приступите к захвату. Не убейте специалистов, будте аккуратны.
