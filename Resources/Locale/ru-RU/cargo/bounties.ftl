...
bounty-description-artifact = Stellar Exctraction находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полёты. Верните один, и мы выплатим за него компенсацию.
...
bounty-description-donut = Корпоративная Милиция несёт большие потери в борьбе с Синдикатом. Отправьте пончики для поднятия боевого духа.
...
bounty-description-knife = Один из наших лучших командиров недавно выиграл совершенно новый набор ножей на официальном игровом шоу Stellar Exctraction. К сожалению, у нас нет такого набора под рукой. Пришлите нам кучу острых предметов, чтобы мы могли что-нибудь придумать.
...
bounty-description-pancake = В Stellar Exctraction мы считаем сотрудников семьёй. А вы знаете, что любят семьи? Блины. Отправьте дюжину.
...
bounty-description-soup = Чтобы подавить восстание бездомных, Stellar Exctraction будет угощать супом всех малооплачиваемых работников. Отправьте любой вид супа.
bounty-description-spear = Корпоративная Милиция переживает сокращение бюджета. Вам заплатят, если вы доставите набор копий.
...
bounty-description-rollerskates = Корпоративная Милиция предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
...
bounty-description-wine = Новая библиотекарша и комиссар снабжения влюбились друг в друга по уши после того, как она застала его за разборкой книжных полок на дрова. Пришлите пару бутылок вина (или банок, если хотите), чтобы свидание прошло удачно.
