...
chat-manager-rate-limited = Вы отправляете сообщение СЛИШКОМ быстро!
chat-manager-rate-limit-admin-announcement = Игрок { $player } превысил лимит отправленных сообщений. Проверте его.
