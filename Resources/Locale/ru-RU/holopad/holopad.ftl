...
# S ecurity
holopad-security-front = МИЛ — Приёмная
holopad-security-brig = МИЛ — Бриг
holopad-security-warden = МИЛ — Смотритель
holopad-security-interrogation = МИЛ — Допросная
holopad-security-breakroom = МИЛ — Комната отдыха
holopad-security-detective = МИЛ — Детектив
holopad-security-perma = МИЛ — Перма
holopad-security-courtroom = МИЛ — Зал суда
holopad-security-lawyer = МИЛ — АВД
holopad-security-armory = МИЛ — Оружейная
holopad-security-locker-room = МИЛ — Раздевалка
holopad-security-brig-med = МИЛ — Бригмед
holopad-security-evac-checkpoint = МИЛ — КПП Эвакуация
holopad-security-arrivals-checkpoint = МИЛ — КПП Прибытие
# Service
