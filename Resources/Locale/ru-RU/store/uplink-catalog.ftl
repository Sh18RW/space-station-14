...
uplink-death-acidifier-implant-name = Имплант Кислотного Разложения
uplink-death-acidifier-implant-desc = Имплант при срабатывании с помощью кислоты делает непригодными все вещи.
uplink-micro-bomb-implanter-name = Имплант Микробомбы
uplink-micro-bomb-implanter-desc = При срабатывании поднимает всё на воздух... Ну или убивает цель, как использовать будете.
# Bundles
