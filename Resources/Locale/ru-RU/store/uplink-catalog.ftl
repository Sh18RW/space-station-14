...
uplink-death-acidifier-implant-name = Имплант Кислотного Разлоения
uplink-death-acidifier-implant-desc = Имлпант при срабатывании с помощью кислоты делает непригодным все вещи.
uplink-micro-bomb-implanter-name = Имплант Микробомыбы
uplink-micro-bomb-implanter-desc = При срабаывании полнимает всё на воздух... Ну или убивает цель, как использовать будете.
# Bundles
