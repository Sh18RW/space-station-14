...
ent-FoodCakeLemonSlice = кусок лимонного торта
    .desc = { ent-FoodCakeSliceBase.desc }
ent-FoodCakeLemoon = лимооный торт
    .desc = Торт, символизирующий луну земли.
ent-FoodCakeLemoonSlice = кусок лимооного торта
    .desc = Кусочек луны, пахнущего молоком.
...
ent-FoodCakeSpacemanSlice = кусок космонавтского торта
    .desc = Торт из трубы космонавта с глазурью.
ent-MobCatCake = Тортик
    .desc = Это торт. Это и кот. Это Тортик.
