...
ent-BedsheetCaptain = одеяло капитана
    .desc = Оно украшено эмблемой Stellar Extraction и соткано из революционно нового вида нитей, понижающих шанс проникновения большинства нехимических веществ до 0,01%. Популярно среди многих современных капитанов.
...
ent-BedsheetNT = одеяло SE
    .desc = Имеет эмблему Stellar Extraction, и от него исходит аура долга.
ent-BedsheetOrange = оранжевое одеяло
    .desc = { ent-BedsheetBase.desc }
ent-BedsheetPurple = фиолетовое одеяло
    .desc = { ent-BedsheetBase.desc }
ent-BedsheetQM = одеяло комиссара снабжения
    .desc = { ent-BedsheetBase.desc }
