...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Stellar Extraction.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Stellar Extraction.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности на станции, подготовленная Stellar Extraction. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
...
ent-BookSpaceLaw = Корпоративный закон
    .desc = Набор правил Stellar Extraction для поддержания закона и порядка на своих космических станциях.
