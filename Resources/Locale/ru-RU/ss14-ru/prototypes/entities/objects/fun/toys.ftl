...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч — один из самых популярных продуктов компании Stellar Extraction. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' — Nanotrasen.
...
ent-BalloonNT = воздушный шарик Stellar Extraction
