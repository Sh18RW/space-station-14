...
ent-ClothingOuterArmorPodWars = ironclad II доспех
    .desc = Переделанный комплект доспехов ironclad II, реликвия войн стручков.
ent-ClothingOuterArmorBSOCarapace = кираса офицера синего щита
    .desc = Абсолютно все должны знать, что её хозяин очень опасен (и брутален).
