...
ent-ClothingUniformJumpsuitBSO = костюм офицера синего щита
    .desc = Строгий вид, гладкая, без единой складки, форма. Ах, вот бы на него смотреть вечно!!
ent-ClothingUniformUssrGroundTroopOfficer = форма офицера наземных войск СССР
    .desc = Мы никогда не забудем Советский Союз, Новиков...
