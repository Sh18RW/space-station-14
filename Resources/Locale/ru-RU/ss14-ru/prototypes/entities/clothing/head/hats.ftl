...
ent-ClothingHeadHatBeretBso = берет офицера синего щита
    .desc = Кратен, опаснен и прекрасен.
ent-ClothingHeadHatUssrOfficerCap = фуражка офицера наземных сил СССР
    .desc = Слава Революционному Совету! Слава Новикову!
ent-ClothingHeadHatUssrOfficerBeret = берет офицера наземных сил СССР
    .desc = Если вы решили вернуть Советов, это ваш выбор! Слава Новикову!
ent-ClothingHeadHatUssrUshanka = типичная советская ушанка
    .desc = Где-то здесь есть водка, я чую! Ох, звезда напонимает нам о Новикове...
ent-ClothingHeadHatSanta = головной убор Деда Мороза
    .desc = Хм, мне казалось, что борода у Деда Мороза должна быть настоящей.
