doc-text-printer-report-station =
    ...
    ⠀[color=#1b487e]░░█░██░██░░██░█░░[/color]               [head=3]Stellar Exctraction[/head]
...
doc-text-printer-shuttle-registration-request =
    ...
    Я, (ФИО), в должности (полное наименование должности), прошу провести регистрацию шаттла в системе Stellar Exctraction для идентификации.
    Размеры шаттла:
