...
# Nanotrasen
marking-CyberlimbRArmNanotrasen = Протез, правая рука (Stellar Exctraction)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (Stellar Exctraction)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (Stellar Exctraction)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (Stellar Exctraction)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (Stellar Exctraction)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (Stellar Exctraction)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (Stellar Exctraction)
