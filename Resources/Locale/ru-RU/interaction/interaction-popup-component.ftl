...
petting-success-carp = Вы гладите { THE($target) } по { POSS-ADJ($target) } маленькой голове рыбки.
...
petting-success-snake = Вы гладите { THE($target) } по { POSS-ADJ($target) } чушуйчатой голове.
...
petting-failure-carp = Вы тянетесь погладить { THE($target) }, но { POSS_ADJ($target) } заставляет Вас подумать дважды.
...
petting-failure-pig = Вы тянетесь погладить { THE($target) }, но на Вас завизжали!
