...
signal-port-description-decaying = Этот порт срабаывает, когда связанная аномалия начинает распадаться.
signal-port-name-stabilize = Стабилизация
signal-port-description-stabilize = Этот порт срабатывает, когда связанная аномалия стабилизируется.
signal-port-name-growing = Рост
signal-port-description-growing = Этот порт срабатывает, когда связанная аномалия начинает расти.
signal-port-name-pulse = Импульс
signal-port-description-pulse = Этот порт срабатывает, когда аномалия пульсирует.
signal-port-name-supercrit = Критичное состояние
signal-port-description-supercrit = Этот порт срабатывает, когда аномалия достигла критического состояния.
