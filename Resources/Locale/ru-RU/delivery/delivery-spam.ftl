...
delivery-spam-2 = Причины выбрать Stellar Extraction!
    .desc = Реклама Stellar Extraction.
    .content =
        ...
        ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ STELLAR EXTRACTION, МИРНЫЕ СОТРУДНИКИ СИНДИКАТА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-7 = Отправьте подкрепление!
    ...
    .content =
        ...
        { "[head=2]Это официальное уведомление [color=red]Начальника Службы Безопасности[/color] Космической станции 15 Stellar Exctraction.[/head]" }
...
delivery-spam-9 = Хочешь сразиться?!
    ...
    .content =
        ...
        Скрытая в глубинах станции Stellar Exctraction, запатентованная [color=#FF0000][bold]КЛЕТКА ЯРОСТИ[/bold][/color]! Эта электрифицированная арена создана только для сильнейших, в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] трусы отделяются от воинов, салаги — от солдат, а неудачники — от победителей.
        ──────────────────────────────────────────
...
delivery-spam-12 = Присоединяйтесь к нам на первом рейсе!
    ...
    .content =
        ...
        { "[head=3]Исследуйте руины Агатара***, теперь открытые для публики благодаря помощи лучших учёных Stellar Exctraction. Все тайны древней Агатарской цивилизации раскопаны и выставлены для вашего удовольствия![/head]" }
