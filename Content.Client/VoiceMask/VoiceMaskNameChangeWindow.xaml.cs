...
public sealed partial class VoiceMaskNameChangeWindow : FancyWindow
{
    ...
    public Action<string>? OnVoiceChange; // CP-TTS

    private readonly List<(string, string)> _verbs = [];
    private List<TTSVoicePrototype> _voices = []; // CP-TTS
    ...
    public VoiceMaskNameChangeWindow()
    {
        ...
        // CP-TTS-start
        if (IoCManager.Resolve<IConfigurationManager>().GetCVar(CPCCVars.TTSEnabled))
        {
    ...
    public void UpdateState(string name, string voice, string? verb) // CP-TTS
    {
